        ...
        <div className='relative min-h-screen'>
            ...
            >
                <div
                    ...
                    style={{
                        backgroundImage: "linear-gradient(90deg, rgba(33, 33, 33, 0.86), rgba(33, 33, 33, 0.86))"
                    }}
                ></div>
            </div>
                    ...
                    <div className='flex-2'>
                        <div className='flex gap-4 md:gap-8'>
                            ...
                            <h3 className="leading-10 md:leading-20 font-extrabold text-3xl md:text-7xl text-white">
                                <span className='block'>ELEVATE Caribbean Edition Trinidad</span>
                        ...
                        <div className='flex flex-col gap-6 text-white'>
                            <h2 className='font-extrabold text-xl'>Transforming Procurement Excellence & Leadership </h2>
                            <p className='text-sm md:text-lg leading-normal md:leading-relaxed'>Welcome to Elevate 2025: Caribbean Edition, a premier two-day procurement conference hosted in trinidad & Tobago, specifically tailored to empower procurement professionals at every stage of their career. Elevate your knowledge, expand your network, and enhance your procurement skills with expert-led sessions uniquely designed for the Caribbean context.</p>
