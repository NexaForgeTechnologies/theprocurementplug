                ...
                <div className='block lg:flex gap-6 md:gap-8'>
                    ...
                    <div className='flex-1 bg-white rounded-2xl p-6 md:p-8 mt-6 md:mt-0 flex flex-col gap-6 md:gap-8'>
                        ...
                        <div className='text-[#363636] flex flex-col gap-2'>
                            ...
                            <p className='text-sm md:text-lg leading-normal md:leading-relaxed'>
                                <strong className='font-extrabold'>Location: </strong>4Th Floor, City Tower, New York Street, Manchester M1 4BT
                            </p>
                            <p className='text-sm md:text-lg leading-normal md:leading-relaxed'>
                                <strong className='font-extrabold'>Designed For: </strong>Manchester Edition is designed for procurement professionals, focusing on innovation, strategy, and leadership in procurement.
                            </p>
                        </div>
