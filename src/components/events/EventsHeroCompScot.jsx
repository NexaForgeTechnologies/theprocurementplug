                    ...
                    <div className='flex-1 bg-white rounded-2xl p-6 md:p-8 mt-6 md:mt-0 flex flex-col gap-6 md:gap-8'>
                        ...
                        <div className='text-[#363636] flex flex-col gap-2'>
                            <p className='text-sm md:text-lg leading-normal md:leading-relaxed'>
                                <strong className='font-extrabold'>Event Date & Time: </strong>26th August 2025, 8:30am to 5pm
                            </p>
                            <p className='text-sm md:text-lg leading-normal md:leading-relaxed'>
                                <strong className='font-extrabold'>Location: </strong>3rd Floor, Beacon Building 176 St Vincent St Glasgow G2 5SG</p>
                            <p className='text-sm md:text-lg leading-normal md:leading-relaxed'>
                                <strong className='font-extrabold'>Designed For: </strong>Senior procurement leaders, CPOs, Procurement Directors
                            </p>
                        </div>
                        <p className='text-[#363636] text-sm md:text-lg leading-normal md:leading-relaxed'>
                            <strong className='font-extrabold'>Early Bird Tickets: </strong>395£
                        </p>
                        <Link href="https://www.trybooking.com/uk/EVTX" target='_blank' className='mt-auto bg-[#9c27b0] rounded-md block text-center md:p-4 p-3'>Book Your Ticket Now!</Link>
                    </div>
                </div>
