                ...
                <div className='block lg:flex gap-6 md:gap-8'>
                    <div className='flex-2'>
                        ...
                        <div className='flex flex-col gap-6 text-white'>
                            <h2 className='font-extrabold text-xl'>Unlock the Skills to Secure Your Seat at the Boardroom Table</h2>
                            <p className='text-sm md:text-lg leading-normal md:leading-relaxed'>Are you looking to accelerate your career into the boardroom? Whether you're aiming for CEO or CEO or an aspiring enterprenuer to break into the industry, this webinar is for you!</p>
