          ...
          <div className="flex-2">
            ...
            <div className="flex flex-col gap-6 text-white my-6 md:my-8">
              <h2 className="font-extrabold text-xl">
                Unlock the Skills to Secure Your Seat at the Boardroom Table
              </h2>
              <p className="text-sm md:text-lg leading-normal md:leading-relaxed">
                Are you looking to accelerate your career into the boardroom?
                Whether you're aiming for CEO or CEO or an aspiring enterprenuer
                to break into the industry, this webinar is for you!
              </p>
              <p className="text-sm md:text-lg leading-normal md:leading-relaxed">
          ...
          <div className="flex-1 bg-white rounded-2xl p-6 md:p-8 mt-6 md:mt-0 flex flex-col gap-6 md:gap-8">
            ...
            <div className="text-[#363636] flex flex-col gap-2">
              <p className="text-sm md:text-lg leading-normal md:leading-relaxed">
                ...
                17th July 2025, 11am to 12:15pm
              </p>
              <p className="text-sm md:text-lg leading-normal md:leading-relaxed">
                <strong className="font-extrabold">Location: </strong>Virtual
                Webinar
              </p>
              <p className="text-sm md:text-lg leading-normal md:leading-relaxed">
                <strong className="font-extrabold">Format: </strong>Keynote
                Speaker, Interactive Q&A
              </p>
            </div>
            ...
            <Link
              href="https://www.trybooking.com/uk/EMRL"
              target="_blank"
