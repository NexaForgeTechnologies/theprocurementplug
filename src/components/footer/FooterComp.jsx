        ...
        <footer style={{
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-6 md:gap-[80px] pb-[20px]">
                <div className="w-full lg:w-1/2 flex flex-col self-start justify-start items-start gap-[25px]">
                    <Link
                        href="/"
                        className="block mb-4 w-[260px] h-[71px]">
                        <img src="/images/footer/Horizontal-V1-copy.png" alt="The Procurement Plug Logo" className="w-full" />
                    </Link>
                    <div className="max-w-[695px]">
                        <p className="text-[17px] mb-[-10px] w-full">Join our newsletter to stay up to date on features and releases.</p>
                    </div>
                ...
                <div className="w-full lg:w-[76%] self-start justify-start grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-5">
                    ...
                    <div className="flex flex-col gap-[20px] w-full p-8 bg-[#121212] rounded-[10px] h-full">
                        ...
                        <ul>
                            <li className="mb-2">
                                <Link href="/partnerships" className="hover:text-[#85009D] cursor-pointer">Partnerships</Link>
                            </li>
                            <li>
                                <Link href="/ico-registered" className="hover:text-[#85009D] cursor-pointer">ICO Registration</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="flex flex-col gap-5 w-full p-8 bg-[#121212] rounded-[10px] h-full">
                        ...
                        <ul>
                            <li className="mb-2">
                                <Link href="/general-terms-conditions/terms-conditions-mentee" className="hover:text-[#85009D] cursor-pointer">Terms & Conditions - Mentees</Link>
                            </li>
                            <li className="mb-2">
                                <Link href="/general-terms-conditions/terms-conditions-mentors-coaches" className="hover:text-[#85009D] cursor-pointer">Terms & Conditions - Mentors & Coaches</Link>
                            </li>
                            <li>
                                <Link href="/general-terms-conditions" className="hover:text-[#85009D] cursor-pointer">General Terms & Conditions</Link>
                            </li>
                        </ul>
                    </div>
                </div>
