        ...
        >
            <div className="flex flex-col items-center md:items-start gap-4">
                ...
                <span
                    ...
                    className="flex justify-center md:justify-start self-center md:self-start items-center cursor-pointer bg-[#b08d57] text-white px-4 py-2 rounded-[6px] w-full md:w-auto">
                    {btntext}
