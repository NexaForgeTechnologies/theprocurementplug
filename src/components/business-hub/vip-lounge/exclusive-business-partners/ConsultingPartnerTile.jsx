...
function ConsultingPartnerTile({ heading, para, category, btntext, bigimg, url = "" }) {
  return (
    <Link
      href={url}
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center md:items-start gap-4">
        ...
        {category && <p className="text-[#1B1B1B] text-base group-hover:text-[#ffff] mb-0 md:mb-8">{category}</p>}
        {btntext && (
