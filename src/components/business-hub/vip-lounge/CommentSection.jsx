...
// export default function CommentItem({ comment, onReplyClick }) {
//   return (
//     <div className="mb-6">
//       {/* User Info */}
...
//       {/* Reply Button */}
//       <button
//         className="text-[#505050] text-sm hover:underline"
...
//         <div className="ml-10 mt-4 border-l pl-4">
