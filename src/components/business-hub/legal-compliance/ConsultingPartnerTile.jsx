...
function ConsultingPartnerTile({ heading, text, url = "" }) {
  return (
    <div className="w-full rounded-2xl border border-[#85009D] hover:border-[#b08d57] bg-white hover:bg-[#85009D] p-5 flex flex-col items-center justify-center text-center text-[#85009D] hover:text-white transition-all duration-200 ease-in-out">
