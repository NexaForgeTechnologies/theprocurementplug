...
function VenueTile({ data }) {
  ...
  return (
    <Link
      ...
      onClick={() => setVenue(data)} // save data before navigating
    ...
    >
      ...
      <div>
        ...
        <p className="text-[#1B1B1B] text-base group-hover:text-white">{data.capacity_name}</p>
      </div>

      <button onClick={() => setVenue(data)} className="mt-auto flex items-center cursor-pointer bg-[#b08d57] text-white px-4 py-2 rounded-[6px]">View Details
