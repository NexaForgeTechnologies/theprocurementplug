...
export default function RequestMentoringSession({ isOpen, onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch("/api/personal-development-hub/mentors-and-coaches/request-mentoring-session", {
                method: "POST",
                body: data,
            });
            ...
            if (res.ok) {
                ...
                // Show success popup, then close modal
        ...
        <div className="fixed inset-0 backdrop-blur-xs bg-opacity-30 z-[200] flex items-center justify-center px-6">
            ...
            >
                <div className="flex justify-between items-center mb-4">
                    <h1 className="font-semibold text-2xl md:text-3xl text-[#1B1B1B]">Mentoring Request Workflow</h1>
                ...
                <h2 className="font-semibold text-base md:text-lg text-[#B08D57] mt-2 mb-3">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <textarea
                        ...
                        required
                        onChange={handleChange}
                        placeholder="I'm preparing for my Six Sigma Green Belt..."
                    ...
                    {/* Availability */}
                    <h2 className="font-semibold text-base md:text-lg text-[#1B1B1B] mt-2 mb-3">Proposed availability</h2>
                    <div className="w-full border border-[#D78BE0] bg-white rounded-[4px] p-4 flex flex-col md:flex-row items-center justify-between gap-4">

                        {/* Time From */}
                        <div className="flex-1">
                            <label htmlFor="timeFrom" className="block text-gray-600 mb-1">From</label>
                            <input
                                type="datetime-local"
                                id="timeFrom"
                                name="timeFrom"
                        ...
                        {/* Icon */}
                        <div className="text-[#85009D] text-xl flex items-center justify-center">
                            ⇆
                        </div>

                        {/* Time To */}
                        <div className="flex-1">
                            <label htmlFor="timeTo" className="block text-gray-600 mb-1">To</label>
                            <input
                                type="datetime-local"
                                id="timeTo"
                                name="timeTo"
                    ...
                    {/* Upload CV */}
                    <div>
                        <h2 className="font-semibold text-base md:text-lg text-[#1B1B1B] mt-2 mb-3">
                            Upload file Resume (optional)
                        </h2>
                        <label
                        ...
                        >
                            <Image
                                src="/images/personaldevelopmenthub/welcome-mentors-directory/mentors-coaches-directory/category/mentor/upload.png"
                                alt="upload resume"
                                width={128}
                                height={128}
            ...
            <SuccessPopup
                ...
                message="We’ll review your details and get back to you shortly to confirm your consultation call."
            />
        </div>
    );
}
