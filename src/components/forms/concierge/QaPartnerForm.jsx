...
export default function PersonalDetailForm({ isOpen, onClose }) {
  ...
  const experienceOptions = [
    {
      value: "Years of Procurement Experience",
          ...
          >
            ...
            {selectedFileName ? (
              <div className="flex items-center gap-2">
                <p className="text-[#1B1B1B] text-center font-medium">
                  {selectedFileName}
                </p>
                <button
                  type="button"
              ...
              onChange={(e) => {
                ...
                if (file) {
                  ...
                  if (!validTypes.includes(file.type)) {
                    alert(
                      "Please upload a valid PDF or Word document (.pdf, .doc, .docx)."
                    );
                    return;
                  }
