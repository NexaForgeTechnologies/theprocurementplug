...
export default function RequestCustomHiringForm({ isOpen, onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch("/api/business-hub/vip-lounge/talent-hiring-intelligence/request-custom-hiring", {
                method: "POST",
                body: FormDataObj,
            });
