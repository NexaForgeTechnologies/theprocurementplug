        ...
        <>
            <div>
                ...
                <Image
                    ...
                    height={451}
                />
                <h2 className="text-xl md:text-2xl font-semibold mb-4 text-[#85009D]">Grand Horizon Hall</h2>
                <p className="text-[#1B1B1B] text-base group-hover:text-white">New York City</p>
                <p className="text-[#1B1B1B] text-base group-hover:text-white mt-2">500+ Capacity</p>
            </div>
            <div>
                <h3 className="font-semibold text-2xl md:text-3xl text-[#1B1B1B] mb-4">
                    Overview
                ...
                <p className="max-w-[930px] md:text-xl text-[#1B1B1B] mb-4">
                    Grand Horizon Hall is a premier event venue located in the heart of New York City, offering over 500-person
                    capacity ideal for large-scale procurement events, conferences, and corporate gatherings. With modern
                    facilities, flexible layouts, and top-tier amenities, it provides a professional setting tailored to elevate any
                    event experience.
                </p>
                <button
