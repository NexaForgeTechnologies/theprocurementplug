...
export default function RequestIntroForm({ isOpen, onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch("/api/business-hub/vip-lounge/talent-hiring-intelligence/request-intro", {
                method: "POST",
                body: FormDataObj,
            });
        ...
        <div className="fixed inset-0 backdrop-blur-xs bg-opacity-30 z-[200] flex items-center justify-center px-6">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                        {isLoading ? "Submitting..." : "Request Intro"}
                        {!isLoading && (
