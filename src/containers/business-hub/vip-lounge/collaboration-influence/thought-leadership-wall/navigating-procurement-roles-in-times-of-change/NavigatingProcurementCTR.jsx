...
function NavigatingProcurementCTR() {
            ...
            <div className="flex justify-between items-center text-start flex-col-reverse md:flex-row mb-6 md:mb-8">
                <div>
                    <h3 className="max-w-[820px] leading-none font-semibold text-[24px] md:text-[52px] mb-4 text-[#85009D]">
                        Navigating Procurement Roles in <span className="font-normal">Times of change</span>
                    </h3>
                    <p className="text-[16px] md:text-[20px] text-[#1B1B1B] mb-4 md:mb-2 font-semibold">Name: <span className="font-normal">Ethan</span></p>
                ...
                <div className="mb-4 md:mb-0">
                    <Image
                        src={"/images/bussiness-hub/vip-lounge/Collaboration-influence-zone/thought-leadership-wall/vom.png"}
                        alt={`memeber`}
                        width={300}
                        height={300}
...
export default NavigatingProcurementCTR;
