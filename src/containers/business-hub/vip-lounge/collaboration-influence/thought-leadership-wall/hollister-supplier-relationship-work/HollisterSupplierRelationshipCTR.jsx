...
function HollisterSupplierRelationshipCTR() {
            ...
            <div className="flex justify-between items-center text-start flex-col-reverse md:flex-row mb-6 md:mb-8">
                <div>
                    <h3 className="max-w-[820px] leading-none font-semibold text-[24px] md:text-[52px] mb-4 text-[#85009D]">
                        Hollister Supplier <span className="font-normal">Relationship work</span>
                    </h3>
                    <p className="text-[16px] md:text-[20px] text-[#1B1B1B] mb-4 md:mb-2 font-semibold">Name: <span className="font-normal">Maverick</span></p>
                    ...
                    <h3 className="font-normal text-[24px] md:text-[42px] text-[#B08D57]">
                        Sponsored by <span className="font-semibold">Innotech</span>
                    </h3>
                </div>
                <div className="mb-4 md:mb-0">
                    <Image
                        src={"/images/bussiness-hub/vip-lounge/Collaboration-influence-zone/thought-leadership-wall/member3.png"}
                        alt={`memeber`}
                        width={300}
                        height={300}
...
export default HollisterSupplierRelationshipCTR;
