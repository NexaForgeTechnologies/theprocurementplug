...
export default function JoinTheWaitlistForm({ isOpen, onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch("/api/business-hub/vip-lounge/collaboration-influence/executive-roundtables", {
                method: "POST",
                headers: {
                ...
                >
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="font-semibold text-2xl md:text-3xl text-[#1B1B1B]">
                            Join the wailist for XecXchange Access
                        </h3>
                        <button
