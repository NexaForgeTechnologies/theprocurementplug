        ...
        <>
            <div>
                <HeroCTR
                    ...
                    heading={<span className='flex flex-row items-center gap-2 leading-none'><span className="font-extrabold">The Business </span>Hub</span>}
                ...
                <div className="max-w-[930px]">
                    <p className="md:text-xl text-[#1B1B1B] mt-4 mb-2">
                        <strong>Procurement Strategy & Transformation:</strong> Improve procure-mentorations with data-driven strategies
                        and best practices.
                    </p>
                    <p className="md:text-xl text-[#1B1B1B] mb-2">
                        <strong>Market Research:</strong>
                        Access industry reports and analytics make informed bussiness decisions.
                    </p>
                    <p className="md:text-xl text-[#1B1B1B] mb-2">
                        <strong>Sustainability & ESG Initiatives:</strong>
                        Drive ethical and sustainable procurement practices aligned with global standards
                    </p>
                    <p className="md:text-xl text-[#1B1B1B] mb-4 md:mb-8">
                        <strong>Legal & Compliance:</strong>
                        Strengthen procurement governance with research-led risk assessment and mitigation strategies.
                    </p>
                </div>
                        ...
                        return (
                            ...
                            >
                                <BussinessTile
                                    ...
                                    url={partner.url}
                                    bgImage={isLast ? "/images/bussiness-hub/lastile.png" : ""}
                                    isLast={isLast} 
                                />
                            </div>
                        );
