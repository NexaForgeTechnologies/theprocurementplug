...
function BussinessHubCTR() {
  ...
  const bussinesstile = [
    ...
    },
    {
      id: 2,
      heading: "Events",
      para: "Join webinars, seminars, and workshops to learn and network.",
      btntext: "View Details",
    ...
    },
    {
      ...
      para: "Work with experts in Six Sigma, Change, and Sustainability.",
      btntext: "View Details",
    ...
    },
    {
      ...
      para: "Find top venues for your corporate and networking events.",
      btntext: "View Details",
    ...
    },
    {
      ...
      para: "Discover smart tools to optimize procurement.",
      btntext: "View Details",
    ...
    },
    {
      ...
      para: "Stay aligned with legal and regulatory standards.",
      btntext: "View Details",
    ...
    },
    {
      ...
      para: "Promote ethical, sustainable, and social impact.",
