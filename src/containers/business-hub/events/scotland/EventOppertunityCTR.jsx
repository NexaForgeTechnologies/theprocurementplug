    ...
    return (
        <div className="flex flex-col gap-6 md:gap-8">
            ...
            <div className='relative bg-[#7E0095] rounded-[10px] p-6 flex flex-col justify-between gap-2 text-center lg:text-start'>
                <h2 className='text-[#ffff] font-extrabold text-lg leading-6 md:leading-6'>Relive the Moments from Elevate GLASGOW 2025</h2>
                <div className='flex flex-col lg:flex-row justify-between items-center w-full gap-4 lg:gap-0'>
                    ...
                    <Link
                        href={"https://youtube.com/playlist?list=PLfsOuinzybi6kuhZyiNQqVhzDgpfoYxXG&si=GAfz9rMjcLMzC2sK"}
