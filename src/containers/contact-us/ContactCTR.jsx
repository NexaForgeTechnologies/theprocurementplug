    ...
    <>
      <div className="mt-10 flex flex-col md:flex-row gap-6 md:gap-8">
        <div className="flex-1">
          ...
          <strong className="text-[#363636] text-sm md:text-lg">
            Have questions or need assistance?
          </strong>
          <p className="text-[#363636] text-sm md:text-lg">
            Our friendly team is here to help! Whether you’re looking for more
            information about our services, need support, or just want to share
            feedback, we’d love to hear from you. Simply fill out the form
            below, and a member of our team will get back to you as soon as
            possible. Let’s connect and make great things happen together!
          </p>
        </div>
          ...
          <div>
            ...
            <div className="ml-7 mt-1">
              ...
              <Link
                ...
                className="text-[#ffff] bg-[#212121] mt-3 text-sm md:text-lg cursor-pointer flex items-center gap-2 p-3 rounded-lg w-full md:max-w-max"
              >
      ...
      <Image
        ...
        alt="contact us"
        className="w-full md:h-[600px] rounded-2xl object-cover"
      />
      <div className="flex flex-col md:flex-row gap-6 md:gap-8">
        <div className="flex-1">
          <h2 className="font-extrabold text-3xl md:text-5xl text-[#010101] mb-2 md:mb-4">
            Drop Us A Message
          </h2>
          <p className="text-sm md:text-lg text-[#363636] w-full">
            We love to hear from our clients and userbase. Drop us a message and
