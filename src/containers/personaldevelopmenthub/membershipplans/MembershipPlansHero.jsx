    ...
    return (
        <>
            <div className="flex flex-col gap-y-4 text-white py-10 items-start">
                <h1 className="text-2xl md:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-[#FEF989] via-[#DEAE1A] to-[#FBF687] bg-clip-text text-transparent">Membership Plan </h1>
