            ...
            <div className='flex flex-col lg:flex-row items-center gap-6 md:gap-8'>
                ...
                <div className='flex-1 flex flex-col gap-4 md:gap-6 text-[#363636]'>
                    ...
                    <div>
                        ...
                        <p className='text-[#363636] text-sm md:text-lg leading-normal md:leading-relaxed'>Gain exclusive access to top industry CPOs, CEOs, COOs and MDs. Leverage these exclusive networking opportunities to build vital relationship, gain insider insights, and accelerate your career by connecting with the leaders shaping the future of our industry</p>
                    </div>
