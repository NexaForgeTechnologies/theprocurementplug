...
import StrategyVolatileMarketCTR from '@/containers/business-hub/vip-lounge/collaboration-influence/thought-leadership-wall/category-strategy-in-a-volatile-market/StrategyVolatileMarketCTR'
        ...
        <nav className="text-sm breadcrumbs my-4 md:my-10">
            <ol className="list-reset flex gap-2 text-[#9C9C9C] whitespace-nowrap overflow-x-auto scrollbar-none md:overflow-x-hidden" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                ...
                <li className="text-[#696969] ">
                    Category Strategy In A Volatile Market
                </li>
            </ol>
        </nav>
    )
